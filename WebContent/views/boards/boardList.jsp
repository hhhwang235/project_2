		 ...
		 <tr align="center">
		 	<td colspan="5">
		 		<form action="boardSearch.do" method="post">
		 			<select name="part" style="width: 150px; height:40px;">
		 				<option value="b_subject" >제목</option>
		 				<option value="b_content">내용</option>
		 				<option value="b_writer">작성자</option>
		 			</select>
		 			<input type="text" name="searchData" required="required" style="width: 180px; height:30px;"/>
		 			<input type="submit" value="검색" style="width: 150px; height:40px;"/> 
		 			<input type="button" value="글쓰기" onclick="location.href='boardInsertForm.do'" style="width: 150px; height:40px;"/>
		 		</form>
