...
public class MyMarketInsertAction implements Action {
	@Override
...
//		String realFolder = request.getRealPath(saveFoleder);
		...
		realFolder = "C:\\Users\\myhoh\\eclipse-workspace\\Project2\\WebContent\\goodsupload";
		...
		GoodsDTO dto = new GoodsDTO(); //BoardBean, BoardVo 라고도 부른다.
		dto.setgCommenter(a);
		dto.setgName(multi.getParameter("g_subject"));
		dto.setgMemo(multi.getParameter("g_memo"));
		dto.setgPrice(Integer.parseInt(multi.getParameter("g_price")));
		dto.setgAmount(Integer.parseInt(multi.getParameter("g_amount")));
		dto.setgImage(multi.getFilesystemName((String) multi.getFileNames().nextElement()));
